...
var author$project$Main$Model = F3(
	function (key, url, isMenuActive) {
		return {o: isMenuActive, V: key, G: url};
	});
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		var initialModel = A3(author$project$Main$Model, key, url, false);
...
var author$project$Main$ResetMenu = {$: 3};
...
var author$project$Main$view = function (model) {
	return {
							...
							[
								...
								_List_fromArray(
									[
										...
										model.o ? elm$html$Html$Attributes$class('is-active') : elm$html$Html$Attributes$class('')
									]),
								_List_fromArray(
									[
									...
									[
										...
										_List_fromArray(
											[
												...
												elm$html$Html$Events$onClick(author$project$Main$ResetMenu)
											]),
										_List_fromArray(
											[
								...
								switch (_n1) {
									...
									case '/contact':
										return A2(
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$src('/img/mail_man.png')
												]),
											_List_Nil);
									default:
										return A2(elm$html$Html$div, _List_Nil, _List_Nil);
		...
		aA: 'Elm Bulma Hamburger'
	};
};
var elm$browser$Browser$application = _Browser_application;
var author$project$Main$main = elm$browser$Browser$application(
	{at: author$project$Main$init, av: author$project$Main$UrlChanged, aw: author$project$Main$LinkClicked, az: author$project$Main$subscriptions, aB: author$project$Main$update, aC: author$project$Main$view});
